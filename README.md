...
| ADO-004 | A vényköteles gyógyszerek áfáját 0%-ra csökkentjük. | :hourglass_flowing_sand: | → [Magyar Péter szerint a kereskedők és a gyógyszertárak nem vezethetnek be burk...](https://nepszava.hu/3329634_magyar-peter-szerint-a-kereskedok-es-a-gyogyszertarak-nem-vezethetnek-be-burkolt-aremelest-a-gyogyszerafa-csokkentes-utan) — "Magyar Péter szerint a kereskedők és a gyógyszertárak nem vezethetnek be burkolt áremelést a gyógyszeráfa-csökkentés után", → [Gyógyszeráfa-csökkentés: januárra csúszik egy fontos könnyítés a betegeknek](https://mandiner.hu/belfold/2026/07/gyogyszerafa-csokkentes-januarra-csuszik-egy-fontos-konnyites-a-betegeknek) — "Szeptember 1-jétől áfamentessé teszi a kormány a vényköteles gyógyszereket" |
| ADO-005 | A tűzifa és az egészséges élelmiszerek áfáját 5%-ra mérsékeljük. | :black_square_button: |  |
| ADO-006 | Széles körben újra elérhetővé tesszük a katát. | :hourglass_flowing_sand: | → [Katás adózás: Kármán András bemondta, mikor állíthatják vissza eredeti formáj...](https://www.portfolio.hu/gazdasag/20260601/katas-adozas-karman-andras-bemondta-mikor-allithatjak-vissza-eredeti-formajaban-840524) — "Kármán András pénzügyminiszter ellenzéki képviselői válaszolva azt mondta, terveik szerint már 2027-től visszaállítják a katás adózási fo...", → [Ekkor vezethetik vissza a KATA adózási rendszerét, erre lehet számítani](https://168.hu/penz/kata-adozas-rendszer-gazdasag-visszaeles-hatas-szabalyok-karman-andras-297672) — "Kármán András pénzügyminiszter az Országgyűlésben, a kormány 2027-től ismét széles körben elérhetővé tenné a kisadózó vállalkozások tétel...", → [Visszatér a kata, áfa- és szja-csökkentés jön, és teljesen új költségvetés – ...](https://hvg.hu/gazdasag/20260512_karman-andras-miniszterjelolti-meghallgatas-koltsegvetes-adorendszer-szja-kata-vagyonado) — "visszavezetik a katát (kisadózók tételes adója), bár a leendő miniszter nem részletezte, pontosan milyen feltételekkel." |
